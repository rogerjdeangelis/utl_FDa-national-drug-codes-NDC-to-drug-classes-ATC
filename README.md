# utl_FDa-national-drug-codes-NDC-to-drug-classes-ATC
Mapping U.S. Food and Drug Administration (FDA) National Drug Codes (NDC) to Drug Classes 
    ...
    **********************************************************************************************************************;                                   
    *                                                                                                                    *;                                   
    *; %let pgm=utl_FDa-national-drug-codes-NDC-to-drug-classes-ATC;                                                     *;                                   
    *                                                                                                                    *;                                   
    *                                                                                                                    *;                                   
    *  The source for this program is                                                                                    *;                                   
    *                                                                                                                    *;                                   
    *  Fabrício Kury: https://github.com/fabkury                                                                         *;                                   
    *                                                                                                                    *;                                   
    ...
    *; libname atc "d:/atc";                                                                                             *;                                   
    *                                                                                                                    *;                                   
    ;  %let token=atc;  * project token                                                                                  *;                                   
    *                                                                                                                    *;                                   
    *  * root directory UNIX and Workstation                                                                             *;                                   
    *                                                                                                                    *;                                   
    *; %let _r = d:/;                                                                                                    *;                                   
    *                                                                                                                    *;                                   
    *; %let pgmloc = c:\utl;  ** sas code ker_###TTT.sas;                                                                *;                                   
    *; %let otoloc = c:\oto;  ** autocall library;                                                                       *;                                   
    *                                                                                                                    *;                                   
    *                                                                                                                    *;                                   
    *; %let Description=Given NDC codes lookup corresponding ATC codes with Dailt Dosing;                                *;                                   
    *                                                                                                                    *;                                   
    *   *_                   _                                                                                           *;                                   
    ...
    *                                                                                                                    *;                                   
    *                                                                                                                    *;                                   
    *  I split the R code into four Parts, because the definition of inputs, outputs and option is in the middle         *;                                   
    *  of Fabricios code.                                                                                                *;                                   
    *                                                                                                                    *;                                   
    *     Part 1: d:/atc/r/atc_setup.R  (Fabricios setup)                                                                *;                                   
    *                                                                                                                    *;                                   
    *     * Inputs, Outputs and Options                                                                                  *;                                   
    *     Part 2: ndc_master     <-read_sas('atc_ndcCde.sas7bdat')                                                       *;                                   
    *             do_atc5        <- TRUE                                                                                 *;                                   
    *             do_atc4        <- FALSE                                                                                *;                                   
    *             do_va          <- FALSE                                                                                *;                                   
    *             do_attributes  <- FALSE                                                                                *;                                   
    ...
    *                                                                                                                    *;                                   
    /*  %utl_submit_r64("                                                                                                *;                                   
    *    source('d:/atc/r/atc_setup.R',echo=F);                                                                          *;                                   
    *    options(stringsAsFactors = F);                                                                                  *;                                   
    *    ndc_master<-read_sas('d:/atc/atc_ndcCde.sas7bdat');                                                             *;                                   
    *    do_atc5 <- TRUE;                                                                                                *;                                   
    *    do_atc4 <- FALSE;                                                                                               *;                                   
    *    do_va <- FALSE;                                                                                                 *;                                   
    *    do_attributes <- FALSE;                                                                                         *;                                   
    ...
    *    global_rds_ignore <- F;                                                                                         *;                                   
    *    source('d:/atc/r/atc_functions.R',echo=F);                                                                      *;                                   
    *    source('d:/atc/r/atc_exec.R',echo=T);                                                                           *;                                   
    *    ndc_master<-read_sas('d:/atc/atc_ndcCde.sas7bdat');                                                             *;                                   
    *    want <- as.data.frame(left_join(ndc_master, code_map, by = 'ndc'));                                             *;                                   
    *    write.xport(want,file='d:/atc/xpt/want.xpt');                                                                   *;                                   
    *  ");                                                                                                              */;                                   
    *                                                                                                                    *;                                   
    ...
    *   WORK.WANT                                                                                                        *;                                   
    *                                                                                                                    *;                                   
    *       NDC          ATC5       RXCUI      IN_NAME      IN_UMLSC  DDD   U                                            *;                                   
    *                                                                                                                    *;                                   
    *   35356-838-30    N02AA01     891888     Morphine     C0026549  0.1   g                                            *;                                   
    *   42858-803-01    N02AA01     891893     Morphine     C0026549  0.1   g                                            *;                                   
    *   49999-169-30    R05DA03     856999     Hydrocodone  C0020264 15.0   mg                                           *;                                   
    *   50436-377-08    N02AX02     835603     Tramadol     C0040610  0.3   g                                            *;                                   
    *   51862-585-01    R05DA03    1492673     Hydrocodone  C0020264 15.0   mg                                           *;                                   
    *   ....                                                                                                             *;                                   
    *                                                                                                                    *;                                   
    *                                                                                                                    *;                                   
    **********************************************************************************************************************;                                   
    *                                                                                                                    *;                                   
    *  Modification Date   Programmer              Requestor        Description         Contact                          *;                                   
    *  -----------------   ---------------        ------------      ---=-------         -------                          *;                                   
    *  28MAY2019           Roger Deangelis        Roger DeAngelis    Creation           Roger.Deangelis@gmail.com        *;                                   
    *                                                                                                                    *;                                   
    **********************************************************************************************************************;                                   
    ...
    *           _                _                                                                                                                            
      __ _  ___| |_     ___  ___| |_ _   _ _ __                                                                                                               
     / _` |/ __| __|   / __|/ _ \ __| | | | '_ \                                                                                                              
    | (_| | (__| |_    \__ \  __/ |_| |_| | |_) |                                                                                                             
     \__,_|\___|\__|___|___/\___|\__|\__,_| .__/                                                                                                              
                  |_____|                 |_|                                                                                                                 
    ;                                                                                                                                                         
                                                                                                                                                              
    filename ft15f001 "d:/atc/r/atc_setup.R";                                                                                                                 
    parmcards4;                                                                                                                                               
    #' Mapping U.S. Food and Drug Administration (FDA) National Drug Codes (NDC) to Drug Classes and                                                          
    #' Terminologies by querying the RxNorm API at https://rxnav.nlm.nih.gov.                                                                                 
    #'                                                                                                                                                        
    ...
    *         __                  _   _                                                                                                                       
     _ __    / _|_   _ _ __   ___| |_(_) ___  _ __  ___                                                                                                       
    | '__|  | |_| | | | '_ \ / __| __| |/ _ \| '_ \/ __|                                                                                                      
    | |     |  _| |_| | | | | (__| |_| | (_) | | | \__ \                                                                                                      
    ...
    filename ft15f001 "d:/atc/r/atc_functions.R";                                                                                                             
    parmcards4;                                                                                                                                               
    ...
    wrapRDS(ndc_master, {                                                                                                                                     
      ndc_master_line_1 <- read_lines(ndc_master_file, n_max = 30)                                                                                            
    ...
    *                                                                                                                                                         
    ...
    ;                                                                                                                                                         
    filename ft15f001 "d:/atc/r/atc_exec.R";                                                                                                                  
    parmcards4;                                                                                                                                               
    # Execution start ---------------------------------------------------------------------------                                                             
    ...
    # ndc_master_file <- "d:/atc/txt/package.txt";                                                                                                            
    ...
    if(is_tibble(ndc_master)) {                                                                                                                               
      console('Read ', nrow(ndc_master), ' rows ')                                                                                                            
    } else                                                                                                                                                    
    ...
    if(T) {                                                                                                                                                   
      map_outfile <- paste0("d:/atc/csv/", 'ndc_map ', curtime(), ' (', exec_label, ').csv')                                                                  
    ...
    *                                                                                                                                                         
    ...
    \__ \ (_| \__ \ | | | | | | (_| | (__| | | (_) |                                                                                                          
    |___/\__,_|___/ |_| |_| |_|\__,_|\___|_|  \___/                                                                                                           
    ...
    libname xpt xport "d:/atc/xpt/want.xpt";                                                                                                                  
    data want;                                                                                                                                                
      set xpt.want;                                                                                                                                           
    run;quit;                                                                                                                                                 
    libname xpt clear;                                                                                                                                        
    ...
    WANT total obs=58                                                                                                                                         
         ...
         NDC         RXCUI    IN_RXCUI   HAS_MIN   IN_TTY   IN_NAME                             IN_SYNON        IN_UMLSC    ATC5      DDD   U    ADM_R   WHOCC
                                                                                                                                                              
     35356-838-30    891888      7052     FALSE     IN      Morphine                                            C0026549   N02AA01    0.1   g     O           
     42858-803-01    891893      7052     FALSE     IN      Morphine                                            C0026549   N02AA01    0.1   g     O           
     49999-169-30    856999       161     TRUE      IN      Acetaminophen                                       C0000970   N02BE01    3.0   g     O           
     49999-169-30    856999      5489     TRUE      IN      Hydrocodone                                         C0020264   R05DA03   15.0   mg    O           
     49999-169-30    856999    214182     TRUE      MIN     Acetaminophen / Hydrocodone                         C0717367               .                      
     50436-377-08    835603     10689     FALSE     IN      Tramadol                                            C0040610   N02AX02    0.3   g     O           
     51862-585-01   1492673       161     TRUE      IN      Acetaminophen                                       C0000970   N02BE01    3.0   g     O           
     51862-585-01   1492673      5489     TRUE      IN      Hydrocodone                                         C0020264   R05DA03   15.0   mg    O           
     51862-585-01   1492673    214182     TRUE      MIN     Acetaminophen / Hydrocodone                         C0717367               .                      
     51991-0194-1    858798      5640     TRUE      IN      Ibuprofen                                           C0020740   C01EB16   30.0   mg    P           
     51991-0194-1    858798      5640     TRUE      IN      Ibuprofen                                           C0020740   G02CC01     .                      
     51991-0194-1    858798      5640     TRUE      IN      Ibuprofen                                           C0020740   M01AE01    1.2   g     O           
     51991-0194-1    858798      5640     TRUE      IN      Ibuprofen                                           C0020740   M02AA13     .                      
     51991-0194-1    858798      5640     TRUE      IN      Ibuprofen                                           C0020740   R02AX02     .                      
